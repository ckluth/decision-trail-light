# Adopting decision-trail-light in your own repo

This is the on-ramp: the mechanical steps for getting decision-trail-light into
a target repository. For *why* the method looks the way it does and how to work
it day to day, read [`guide.md`](guide.md) first — this page is just the
copy-and-customize checklist once you're ready to install it.

Audience: an AI coding agent (or a human) doing the actual copying, on request
from the repo's owner. Read this fully before writing anything into the target
repo.
